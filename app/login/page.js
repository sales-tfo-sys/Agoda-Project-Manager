    ...
    <div className="lg2">
      ...
      <div className="lg2-card">
        <span className="lg2-logo" aria-hidden="true">
          <svg width="60" height="68" viewBox="0 0 62 70" fill="none">
            <defs>
            ...
            <path d="M31 5 54 20 54 50 31 65 8 50 8 20Z" fill="url(#lgHex)" stroke="url(#lgHex)" strokeWidth="12" strokeLinejoin="round" />
            <g fill="#ffffff">
