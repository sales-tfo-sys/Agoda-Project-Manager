    ...
    <div className="wrap">
      ...
      {error ? (
        ...
        <>
          ...
          <div className="tab-panel overview-row">
            ...
            {summary && renderTypes.length > 0 && (
              <SummaryTable
                ...
                edit={!!edits.regular}
                onToggleEdit={canEditTasks ? () => toggleEdit("regular") : undefined}
              />
            )}
            {pending &&
              (() => {
                ...
                return ptypes.length > 0 ? (
                  <SummaryTable
                    ...
                    setOvField={setOvField}
                    edit={!!edits.pending}
                    onToggleEdit={canEditTasks ? () => toggleEdit("pending") : undefined}
                  />
                ) : null;
              })()}
            </div>
          ...
          {tab === "overview" && adhoc && (adhoc.length > 0 || customAdhoc.length > 0) && (() => {
            ...
            return (
              <div className="tab-panel">
                <div className="sec-row">
                  ...
                  {canEditTasks && (
                    <EditToggle on={!!edits.adhoc} onToggle={() => toggleEdit("adhoc")} />
                  )}
                  </span>
                </div>
          ...
          {tab === "cases" && (renderTypes.length === 0 ? (
            <div className="card">
          ...
          {tab === "cases" && yearAgg && yearAgg.noDate > 0 && (
